...
<head>
    ...
    <title>List of house units</title>
...
$records = mysqli_query($db,"select * from houseunits");
while ($data = mysqli_fetch_array($records))
 {
  ...
  <tr>
    ...
    <td><?php echo $data['Unitsavailable']; ?></td>
    <td><?php echo $data['Unitsleft']; ?></td>
    <td><a href="deleteunits.php?HouseID=<?php echo $data['HouseID']; ?>">Delete</a></td>
  </tr>
<?php
}
?>
