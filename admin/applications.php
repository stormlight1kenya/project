...
<div class="tables">
<h2>User House Application Requests</h2>
<table  border="1" class="tlb" >
    <tr>
    <th>Payroll</th>
    <th>Name</th>
    <th>Email</th>
...
$records = mysqli_query($db,"select * from houseapplications");
while ($data = mysqli_fetch_array($records))
 {
  ...
  <tr>
    ...
    <td><a href="deletehouse.php?Payroll=<?php echo $data['Payroll']; ?>">Delete</a></td>
  </tr>
<?php
}
?>
